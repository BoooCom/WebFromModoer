...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li id="btn_config2"><a href="javascript:;" onclick="tabSelect(2,'config');" onfocus="this.blur()">注册与登录</a></li>
            <li id="btn_config3"><a href="javascript:;" onclick="tabSelect(3,'config');" onfocus="this.blur()">第三方网站账号设置</a></li>
        </ul>
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config2" style="display:none;">
            ...
            <tr>
                <td class="altbg1" valign="top">
                    <strong>禁止注册IP列表:</strong>禁止列表内IP地址注册，一行一个IP，同时可以用通配符*来限定IP段，例如：192.168.1.*表示禁止192.168.1.1~192.168.1.255
                </td>
                <td><?=form_textarea('modcfg[reg_banip]',$modcfg['reg_banip'],5,40)?></td>
            </tr>
            <tr>
                <td class="altbg1" valign="top">
                    <strong>禁止登录IP列表:</strong>禁止列表内IP地址登录，一行一个IP，同时可以用通配符*来限定IP段，例如：192.168.1.*表示禁止192.168.1.1~192.168.1.255
                </td>
                <td><?=form_textarea('modcfg[login_banip]',$modcfg['login_banip'],5,40)?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="altbg1"><strong>是否允许手机号登录:</strong>用户登录时可使用注册时填写验证的手机号进行登录。</td>
                <td><?=form_bool('modcfg[mobile_login]',(bool)$modcfg['mobile_login'])?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="altbg1"><strong>启用邀请注册:</strong>通过会员的邀请注册连接，邀请用户和被邀请用户可以获得相应的积分进行奖励<br />
                    <span class="font_1">具体积分奖励，请到“会员模块-积分策略设置”页面进行设置</span></td>
                <td><?=form_bool('modcfg[invite_reg]',(bool)$modcfg['invite_reg'])?></td>
            </tr>
            <tr>
                <td class="altbg1"><strong>邀请者每日最高允许邀请人数</strong>限制邀请者每日可邀请注册的人数；0表示不限制</td>
                <td><?=form_input('modcfg[invite_reg_maxnum]', $modcfg['invite_reg_maxnum']>0?$modcfg['invite_reg_maxnum']:0, 'txtbox4')?>&nbsp;人</td>
            </tr>
        </table>
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config3" style="display:none;">
            ...
            <tr>
                <td class="altbg1"><strong>第三方帐号首次登录时，允许跳过本地注册:</strong>选择允许跳过，则再进入本地注册页面时，显示跳过按钮；选择强制跳过则不显示本地注册页面。</td>
                <td>
                    <?=form_radio('modcfg[passport_reg_skip]', array('0'=>'不允许','normal'=>'允许','force'=>'强制'), $modcfg['passport_reg_skip'])?>
                </td>
            </tr>
            <tr>
                <td class="altbg1" valign="top" width="45%"><strong>第三方帐号首次登录时，要求在本站建立密码:</strong>让用户在使用第三方帐号登录时，需要在本地网站建立新密码，以便帐号可以脱离第三方帐号进行登录</td>
                <td width="*">
            ...
            <tr>
                <td class="altbg1"><strong>腾讯微博 App ID</strong>
                    在 http://connect.qq.com/ 登录申请获取
                    <span class="font_1">申请QQ登录审核时，请打开“第三方帐号首次登录时，允许跳过本地注册”功能，以避免审核失败。</span>
                </td>
                <td>
