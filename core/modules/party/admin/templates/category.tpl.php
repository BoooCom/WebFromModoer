	...
	<div class="space">
		...
		<table class="maintable" border="0" cellspacing="0" cellpadding="0">
			...
			<tr>
                ...
                <td><?=$val['num']?></td>
                <td><a href="<?=cpurl($module,'party','add',array('catid'=>$val['catid']))?>">增加</a>&nbsp;<a href="<?=cpurl($module,'category','delete',array('catid'=>$val['catid']))?>" onclick="return confirm('您确定要删除吗，本次操作将删除本分类下的所有聚会信息。');">删除</a></td>
            </tr>
            <?}?>
            <?else:?>
            <tr>
            ...
            <tr class="altbg1">
                <td>增加</td>
                <td colspan="2"><input type="text" name="newcategory[listorder]" class="txtbox5 width" /></td>
