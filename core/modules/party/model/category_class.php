...
class msm_party_category extends ms_model {

    var $table = 'dbpre_party_category';
	var $key = 'catid';
    ...
    function check_post(& $post, $edit = false) {
        if(!$post['name']) redirect('party_category_name_empty');
    }
    ...
    function write_cache($return=FALSE) {
        ...
        ms_cache::factory()->write('party_category', $result);
