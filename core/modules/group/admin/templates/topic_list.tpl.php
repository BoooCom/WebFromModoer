    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="100" class="altbg1">所属小组ID</td>
                <td width="*">
...
<form method="post" name="myform" action="<?=cpurl($module,$act)?>">
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li<?if($val['flag']=='group:topic')echo' class="selected"';?>><a href="<?=$val['url']?>" onfocus="this.blur()"><?=$val['title']?></a></li>
            <?endforeach;?>
        </ul>
        <?endif;?>
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" trmouse="Y">
            ...
            <tr>
				...
				<td><a href="<?=url("group/$val[gid]")?>" target="_blank"><?=$val['groupname']?></a></td>
                <td><a href="<?=url("group/topic/id/$val[tpid]")?>" target="_blank"><?=$val['subject']?></a></td>
