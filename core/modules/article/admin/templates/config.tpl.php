...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li id="btn_config3"><a href="javascript:;" onclick="tabSelect(3,'config');" onfocus="this.blur()">多城市功能设置</a></li>
        </ul>
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config1">
            ...
            <tr>
                <td class="altbg1"><strong>发布文章时允许下载远程图片:</strong>前后台用户在发布文章时，后台自动对非本站的图片进行远程下载。<br />
                    <span class="font_1">建议不在发布文章时下载图片，因为此功能会影响文章的发布速度（网络速度和图片数量会影响图片下载时间，甚至出现无法发布文章的问题）</span></td>
                <td>
