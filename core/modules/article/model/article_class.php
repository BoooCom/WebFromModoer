...
class msm_article extends ms_model {
    ...
    function check_post(&$post, $edit=false, $role = 'member') {
        ...
        if(strlen_ex($post['subject'])<2 || strlen_ex($post['subject'])>60) redirect(lang('article_post_subject_len',array(2,60)));
        ...
        if(strlen_ex($post['introduce'])<10 || strlen_ex($post['introduce'])>255) redirect(lang('article_post_introduce_len',array(10,255)));
