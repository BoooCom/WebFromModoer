...
<?=form_begin(cpurl($module,$act))?>
    <div class="space">
        ...
        <ul class="cptab">
            ...
            <li id="btn_config4"><a href="javascript:;" onclick="tabSelect(4,'config');" onfocus="this.blur()">SEO设置</a></li>
        </ul>
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0" id="config4" style="display:none;">
            <tr>
                ...
                <td width="*">
                    <p><input type="text" name="modcfg[seo_category_title]" value="<?=$modcfg['seo_category_title']?>" class="txtbox" /> title </p>
            ...
            <tr>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_list_title]" value="<?=$modcfg['seo_list_title']?>" class="txtbox" /> title </p>
            ...
            <?if($category)foreach ($category as $catid => $cate):?>
            <tr>
                <td class="altbg1" valign="top">
                    <div style="margin-left:20px;">
                        <strong>主题列表页——<?=$cate['name']?>:</strong>
                        <p>可用标签：
                        <span title="网站名称" class="font_1">{site_name}</span>
                        <span title="网站全局keywords" class="font_1">{site_keywords}</span>
                        <span title="网站全局description" class="font_1">{site_description}</span>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_list_<?=$catid?>_title]" value="<?=$modcfg["seo_list_{$catid}_title"]?>" class="txtbox" /> title </p>
                    <p><input type="text" name="modcfg[seo_list_<?=$catid?>_keywords]" value="<?=$modcfg["seo_list_{$catid}_keywords"]?>" class="txtbox" /> keywords </p>
                    <p><input type="text" name="modcfg[seo_list_<?=$catid?>_description]" value="<?=$modcfg["seo_list_{$catid}_description"]?>" class="txtbox" /> description</p>
                </td>
            </tr>
            <?endforeach;?>
            <tr>
                <td class="altbg1" valign="top">
                    <strong>主题内容页——全局:</strong>
                    未设置分类seo时，默认使用当前设置
                    <p>可用标签：
                    <span title="网站名称" class="font_1">{site_name}</span>
                    <span title="网站全局keywords" class="font_1">{site_keywords}</span>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_detail_title]" value="<?=$modcfg['seo_detail_title']?>" class="txtbox" /> title </p>
            ...
            <tr>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_detail_<?=$catid?>_title]" value="<?=$modcfg["seo_detail_{$catid}_title"]?>" class="txtbox" /> title </p>
                    <p><input type="text" name="modcfg[seo_detail_<?=$catid?>_keywords]" value="<?=$modcfg["seo_detail_{$catid}_keywords"]?>" class="txtbox" /> keywords </p>
                    <p><input type="text" name="modcfg[seo_detail_<?=$catid?>_description]" value="<?=$modcfg["seo_detail_{$catid}_description"]?>" class="txtbox" /> description</p>
                </td>
            </tr>
            <?endforeach;?>
            <tr>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_album_title]" value="<?=$modcfg['seo_album_title']?>" class="txtbox" /> title </p>
            ...
            <tr>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_tops_title]" value="<?=$modcfg['seo_tops_title']?>" class="txtbox" /> title </p>
            ...
            <tr>
                ...
                <td>
                    <p><input type="text" name="modcfg[seo_map_title]" value="<?=$modcfg['seo_map_title']?>" class="txtbox" /> title </p>
