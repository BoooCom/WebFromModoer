...
//取得主题信息
if($sid) {
    if(check_module('mobile') && is_mobile() && config('auto_switch','mobile')) {
...
$seo_tags['root_area_name'] = display('modoer:area',"aid/$detail[aid]");
...
$seo_list_title = $MOD["seo_detail_{$pid}_title"] ? $MOD["seo_detail_{$pid}_title"] : $MOD['seo_detail_title'];
$seo_list_keywords = $MOD["seo_detail_{$pid}_keywords"] ? $MOD["seo_detail_{$pid}_keywords"] : $MOD['seo_detail_keywords'];
$seo_list_description = $MOD["seo_detail_{$pid}_description"] ? $MOD["seo_detail_{$pid}_description"] : $MOD['seo_detail_description'];
