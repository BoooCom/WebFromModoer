...
if($total) {
    $multipage = mobile_page($total, $num, $_GET['page'], url("item/mobile/do/list/catid/$catid/aid/$aid/order/$order/type/$type/att/$atturl/num/$num/total/$total/page/_PAGE_"));
    //$wf_multipage = multi($total, $wf_offset, $wf_page, url("item/mobile/do/list/catid/$catid/aid/$aid/order/$order/type/$type/att/$atturl/num/$num/total/$total/wfpage/_PAGE_"));
}
