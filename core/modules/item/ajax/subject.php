...
case 'search':
    ...
    $_GET['catid'] = _input('catid','0', MF_TEXT);
    $_GET['city_id'] = _input('city_id','0', MF_INT_KEY);
    if($_GET['city_id'] > 0) $_GET['city_id'] = array(0,$_GET['city_id']);
...
case 'exists':
    ...
    if($city_id > 0) $city_id = array(0,$city_id);
