...
class msm_datacall extends ms_model {
    ...
    function datacall_fun($callid) {
        ...
        $params['rand'] && $params['orderby'] = 'rand()';
    ...
    function datacall_sql($callid) {
        ...
        $sql = "SELECT " . $params['select'] . " FROM " . $params['from'] . " WHERE " . $params['where'] . " " . $params['other'] . $params['orderby'] . 
            " LIMIT " . $params['limit'];
    ...
    */
    ...
    function write_cache($return = FALSE) {
        ...
        ms_cache::factory()->write('modoer_datacall', $result);
