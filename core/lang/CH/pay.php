...
return array(
    ...
    'pay_withdraw_status_wait' => '等待',
    'pay_withdraw_status_succeed' => '成功',
    'pay_withdraw_status_fail' => '失败',
    'pay_withdraw_status_cancel' => '取消',
    ...
    'pay_point_card_recharge_des' => '积分卡充值',
    ...
    'pay_notice_apply' => '管理员已经处理了您的现金提现申请（流水号：%d），<a href="%s" target="_blank">请点击这里查看详情</a>',
);
?>