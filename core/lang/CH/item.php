...
return array(
    ...
    'item_mysubject_empty' => '您目前没有任何可管理的主题。',
    'item_mysubject_nonentity' => '您选择的主题不是您的主题。',
    ...
    'item_guard_feed_icon' => 'debate',
    'item_guard_feed_title_template' => '{username} 购买并种下一颗葫芦种子',
    'item_guard_feed_body_template' => '{subject}',

    'item_fruit_feed_icon' => 'debate',
    'item_fruit_feed_title_template' => '{subject} 的葫芦成熟了',
    'item_fruit_feed_body_template' => '数量有限，欢迎大家前来采摘！',
    ...
    'item_notice_owner_expirydate_out' => '您对主题 %s 的管理期限已到期。',
);
?>