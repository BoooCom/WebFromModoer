...
<?=form_begin(cpurl($module,$act,$op))?>
    <div class="space">
        ...
        <ul class="cptab">
            <li class="selected" id="btn_config1"><a href="javascript:;" onclick="tabSelect(1,'config');" onfocus="this.blur()">伪静态设置</a></li>
            <li id="btn_config2"><a href="javascript:;" onclick="tabSelect(2,'config');" onfocus="this.blur()">页面优化</a></li>
        </ul>
