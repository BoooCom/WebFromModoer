...
<form method="post" name="myform" action="<?=cpurl($module,$act)?>">
    <div class="space">
        ...
        <center>
            ...
            <input type="button" value="增加菜单" class="btn" onclick="jslocation('<?=cpurl($module, $act, 'add', array('parentid'=>$parentid))?>')" />
            <?if($parentid){?>
            <input type="button" value="返回上一层" class="btn" onclick="jslocation('<?=cpurl($module, $act, 'list', array('parentid'=>$goto_parentid))?>')" />
            <?}?>
        </center>
    </div>
</form>
