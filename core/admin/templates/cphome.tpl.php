...
<div id="body">
    ...
    <?endif;?>
    <?if(!$licinfo || $licinfo < 0 || !$licinfo['l']):?>
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
			...
			<tr><td><textarea name="AF7A41" style="width:99%;height:50px;"></textarea></td></tr>
            <tr>
                <td>
    ...
    <div class="space">
        ...
        <table class="maintable" border="0" cellspacing="0" cellpadding="0">
            <tr><td width="200" class="altbg1"><?=lang('admincp_cphome_cpuser_lic_domain')?>:</td>
            <td><?=$_G['siteinfo']['d']?></td></tr>
			<tr><td class="altbg1"><?=lang('admincp_cphome_cpuser_lic_version')?>:</td>
            <td><?=lang('admincp_sell_version_name_'.$_G['siteinfo']['v'])?></td></tr>
            <tr><td class="altbg1"><?=lang('admincp_cphome_cpuser_lic_lifetime')?>:</td>
            <td><?=date('Y-m-d',$_G['siteinfo']['s'])?> ~ <?=date('Y-m-d',$_G['siteinfo']['s']+$_G['siteinfo']['e']*3600*24)?></td>
            </tr>
        </table>
    </div>
    <?endif;?>
