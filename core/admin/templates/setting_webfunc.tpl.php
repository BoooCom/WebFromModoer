...
<?=form_begin(cpurl($module,$act,$op))?>
    <div class="space">
        ...
        <ul class="cptab">
            <li class="selected" id="btn_config1"><a href="javascript:tabSelect(1,'config');" onfocus="this.blur()">主要功能</a></li>
            <li id="btn_config2"><a href="javascript:tabSelect(2,'config');" onfocus="this.blur()">图片上传</a></li>
            <li id="btn_config3"><a href="javascript:tabSelect(3,'config');" onfocus="this.blur()">JS调用</a></li>
        </ul>
