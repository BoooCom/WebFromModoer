...
<form method="post" name="myform" action="<?=cpurl($module,$act,'')?>">
    ...
    <center>
        ...
        <?php endif;?>
        <input type="button" value="增加新模板" class="btn" onclick="jslocation('<?=cpurl($model,$act,'add',array('filedir'=>$dir))?>');" />&nbsp;
        <input type="button" class="btn" value="<?=lang('global_return')?>" onclick="jslocation('<?=cpurl($module,$act)?>');" />
    </center>
</form>
</div>