...
return array (
  ...
  array (
    ...
    array (
      ...
      'where' => 'mt.idtype={idtype} AND mt.{field:effect}>0 AND s.city_id IN ({array:city_id})',
      'other' => '',
  ...
  array (
    ...
    array (
      ...
      'where' => 'city_id IN ({array:city_id}) and catid={catid} and status=1 and sid!={sid}',
      'other' => '',
  ...
  array (
    ...
    array (
      'from' => '{dbpre}subject',
      'select' => 'sid,pid,catid,name,subname,avgsort,pageviews,reviews',
      'where' => 'city_id IN ({array:city_id}) and name={name} and status=1 and sid!={sid}',
      'other' => '',
      'orderby' => 'addtime DESC',
      'limit' => '0,10',
      'cachetime' => '1000',
  ...
  array (
    ...
    array (
      ...
      'where' => 'city_id IN ({array:city_id}) AND pid={pid} AND status=1 AND finer>0',
      'other' => '',
      'orderby' => 'finer DESC',
      'limit' => '0,8',
      'cachetime' => '1000',
