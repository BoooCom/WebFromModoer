 ...
 tabindex=2>&nbsp;
            ...
            <div id="login_1" class="mainuser" style="display:none;">
                ...
                <div class="mainuser-operation">
                    <div class="mainuser-operation-foo"><span class="member-ico"><a href="<?php echo url("space"); ?>" id="login_name"></a></span><span class="xsplit">|</span><span class="arrwd-ico" id="assistant_menu" rel="assistant_menu_box"><a href="<?php echo url("member/index"); ?>">我的助手</a></span><span class="xsplit">|</span><span class="arrwd-ico" id="manage_menu" rel="manage_menu_box"><a href="<?php echo url("item/member/ac/g_subject"); ?>">主题管理</a></span><span class="xsplit">|</span><span><a href="<?php echo url("member/index/ac/task"); ?>">任务</a><span id="login_task" style="display:none;"></span></span><span class="xsplit">|</span><a href="<?php echo url("member/index/ac/pm/folder/inbox"); ?>">短信箱</a><span id="login_newmsg" style="display:none;">(0)</span><span class="xsplit">|</span><span><a href="<?php echo url("member/index/ac/notice"); ?>">提醒</a><span id="login_notice" style="display:none;"></span></span><span class="xsplit">|</span><a href="<?php echo url("member/login/op/logout"); ?>">退出</a></div>
...
>优惠券</option>
        ...
        <div class="s_right">
            ...
            <div class="shopping-cart cart-ico">
                <?php $C = $_G['loader']->model('product:cart');
                    $cartid = $C->getcookie('shop_cart');
                    $totalp = $C->count_products($cartid);
                 ?>                <span><a href="<?php echo url("product/cart"); ?>">购物车<strong id="cart_num"><? if(isset($_COOKIE['shop_cart']) && !empty($_COOKIE['shop_cart']) && $totalp) { ?>
<?=$totalp?>
<? } else { ?>
0<? } ?>
</strong>件</a></span>
...
<ul id="assistant_menu_box" class="dropdown-menu">
    <? if(check_module('product') && $_MODULES['product']['extra']) { ?>
    <li><a href="<?php echo url("product/member/ac/m_order"); ?>">我的订单</a></li>
    <? } ?>
...
<ul id="manage_menu_box" class="dropdown-menu">
    <? if(check_module('product')) { ?>
    <li><a href="<?php echo url("product/member/ac/g_product"); ?>">产品管理</a></li>
    <? if($_MODULES['product']['extra']) { ?>
    <li><a href="<?php echo url("product/member/ac/g_order"); ?>">订单管理</a></li>
    <? } ?>
    <? } ?>
    <? if(check_module('tuan')) { ?>
    <li><a href="<?php echo url("tuan/member/ac/g_tuan"); ?>">团购管理</a></li>
    <? } ?>
    <li><a href="<?php echo url("item/member/ac/g_album"); ?>">相册管理</a></li>
    <li><a href="<?php echo url("item/member/ac/g_guestbook"); ?>">留言管理</a></li>
</ul>
</script>
